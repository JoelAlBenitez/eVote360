...
{
    public class RejectAllianceCommandHandler : IRejectAllianceCommand
    {
        private readonly IPoliticalAllienceRepository _allianceRepository;
        private readonly IAllianceValidator _allianceValidator;

        public RejectAllianceCommandHandler(IPoliticalAllienceRepository allianceRepository, IAllianceValidator allianceValidator)
        {
